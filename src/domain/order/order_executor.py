...
from src.infrastructure.messaging import ZmqPuller, deserialize # Import ZMQ Puller and deserializer
        ...
        if serialized_signal:
            try:
                ...
                try:
                    ...
                    self.logger.log_info(f"Order sent successfully via ZMQ signal. Result: {result}") 
