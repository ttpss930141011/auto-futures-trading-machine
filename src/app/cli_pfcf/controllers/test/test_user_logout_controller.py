...
def test_user_logout(monkeypatch, mocker, fixture_user):
    ...
    config_mock = mocker.patch('src.app.cli_pfcf.controllers.user_logout_controller.Config')
    ...
    session_manager_mock.get_current_user.return_value = fixture_user["account"]
    ...
    controller = UserLogoutController(logger_mock, config_mock, session_manager_mock)
    controller.execute()
